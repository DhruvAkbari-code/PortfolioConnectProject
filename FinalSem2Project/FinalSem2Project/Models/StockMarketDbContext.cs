...
public partial class StockMarketDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<StockTarget>(entity =>
        {
            ...
            entity.Property(e => e.ConditionValue).HasColumnType("decimal(12, 2)").HasColumnName("condition_value");
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(getutcdate())").HasColumnName("created_at");
            entity.Property(e => e.Exchange).HasMaxLength(10).HasDefaultValue("NSE").HasColumnName("exchange");
            entity.Property(e => e.IsActive).HasDefaultValue(true).HasColumnName("is_active");
            entity.Property(e => e.IsTriggered).HasColumnName("is_triggered");
            entity.Property(e => e.NotifyEmail).HasMaxLength(255).HasColumnName("notify_email");
            entity.Property(e => e.PriceAtCreation).HasColumnType("decimal(12, 2)").HasColumnName("price_at_creation");
            entity.Property(e => e.StockName).HasMaxLength(200).HasColumnName("stock_name");
            entity.Property(e => e.StockSymbol).HasMaxLength(50).HasColumnName("stock_symbol");
            entity.Property(e => e.TargetType).HasMaxLength(30).HasDefaultValue("price_rise").HasColumnName("target_type");
            entity.Property(e => e.TriggeredAt).HasColumnName("triggered_at");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(getutcdate())").HasColumnName("updated_at");
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.GoogleId).HasMaxLength(100).HasColumnName("google_id");
            entity.Property(e => e.IsActive).HasDefaultValue(true).HasColumnName("is_active");
            ...
            entity.Property(e => e.PaymentId).HasMaxLength(255).HasColumnName("payment_id");
            ...
            // ── Zerodha keys ──────────────────────────────────────
            entity.Property(e => e.ZerodhaApiKey).HasMaxLength(100).HasColumnName("ZerodhaApiKey");
            entity.Property(e => e.ZerodhaApiSecret).HasMaxLength(100).HasColumnName("ZerodhaApiSecret");
        });
        ...
        modelBuilder.Entity<Watchlist>(entity =>
        {
            ...
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.AddedAt).HasDefaultValueSql("(getutcdate())").HasColumnName("added_at");
            entity.Property(e => e.Exchange).HasMaxLength(10).HasDefaultValue("NSE").HasColumnName("exchange");
            entity.Property(e => e.PriceAtAdd).HasColumnType("decimal(12, 2)").HasColumnName("price_at_add");
            entity.Property(e => e.StockName).HasMaxLength(200).HasColumnName("stock_name");
            entity.Property(e => e.StockSymbol).HasMaxLength(50).HasColumnName("stock_symbol");
            entity.Property(e => e.UserId).HasColumnName("user_id");
